-- Consolidated release sweep. Other workstreams added tenant-scoped relations
-- after the original multi-company boundary, so the last migration must make
-- the restrictive active-tenant policy universal again.
