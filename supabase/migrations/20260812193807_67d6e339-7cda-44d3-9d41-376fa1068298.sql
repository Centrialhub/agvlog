...
DROP FUNCTION IF EXISTS public.update_driver_settlement_km_review(uuid, numeric, text, text);
...
GRANT EXECUTE ON FUNCTION public.update_driver_settlement_km_review(uuid, numeric, text, text, numeric, numeric) TO authenticated;
