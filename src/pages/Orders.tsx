  ...
  return (
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
      ...
      <div className="flex gap-2 justify-end">
        ...
        <Button onClick={() => onSave({ ...form, quantity: form.quantity ? Number(form.quantity) : null, weight_kg: form.weight_kg ? Number(form.weight_kg) : null, volume_m3: form.volume_m3 ? Number(form.volume_m3) : null, client_id: form.client_id || null })} disabled={!form.order_number.trim()}>Salvar</Button>
      </div>
    </div>
  );
}
