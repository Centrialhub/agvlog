  ...
  return <div className="space-y-5">
    ...
    {page && !query.error && <>
      ...
      <div className="rounded-lg border"><Table><TableHeader><TableRow>
        ...
        <TableCell>{row.account_name}{row.cost_center_name&&<p className="text-xs text-muted-foreground">Centro de custo: {row.cost_center_name}</p>}</TableCell><TableCell><Badge variant="outline">{movementNatures[row.nature]}</Badge></TableCell>
