...
export async function installFreshFinanceFiscalInvoiceLifecycleFixture(db:Pick<PGlite,'exec'>,creditOverride?:string){
 ...
 for(const file of ['20260910004550_finance_fiscal_observation_queue.sql','20260910005509_finance_fiscal_receivable_basis.sql',
  ...
  await db.exec(file.includes('011121')&&creditOverride!==undefined?creditOverride:readFileSync('supabase/migrations/'+file,'utf8')); 
 }
}
