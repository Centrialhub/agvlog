  ...
  const payload = nonEmpty({
    ...
    prestador: {
      ...
      endereco: {
        ...
        cep: onlyDigits(end.cep) ? onlyDigits(end.cep).slice(0, 8).padStart(8, '0') : undefined,
      },
    },
    ...
    tomador: {
      ...
      endereco: {
        ...
        cep: onlyDigits(doc.cliente_cep) ? onlyDigits(doc.cliente_cep).slice(0, 8).padStart(8, '0') : undefined,
