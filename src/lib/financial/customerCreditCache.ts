...
export async function refreshCustomerCredit(cache:QueryClient,tenant:string){
 const scoped=['finance-customer-credit-refund-options','finance-customer-credit-refund-preview','finance-movements','finance-movement-correction-preview','finance-options','finance-payable-options','finance-settlement-expense-context','finance-account-period-evidence','finance-customer-credit-options','finance-customer-credit-preview','receivable-financial-context','receivables','finance-receivable-portfolio','finance-receivable-payments','finance-receivable-history','finance-cash-forecast-preview','finance-cash-forecast-agenda','finance-audit'];
