...
export const navigationSections: NavigationSection[] = [
  ...
  { id: 'operations', label: 'Planejamento e cargas', icon: PackageCheck, items: [
    ...
    { label: 'Custódia de cargas', href: '/trip-cargo-custody', icon: PackageCheck, keywords: 'viagem conferencia lacre avaria canhoto fisico' },
  ...
  { id: 'tracking', label: 'Rastreamento e ocorrências', icon: MapPinned, items: [
    ...
    { label: 'Canhotos', href: '/delivery-receipts', icon: FileCheck2, keywords: 'POD comprovante entrega fornecedor papel' },
  ...
  { id: 'finance', label: 'Financeiro', icon: Wallet, items: [
    ...
    { label: 'Auditoria financeira', href: '/financial/audit', icon: ShieldCheck },
  ...
  { id: 'registry', label: 'Cadastros e estoque', icon: Building2, items: [
    ...
    { label: 'Validação de endereços', href: '/address-resolution', icon: MapPinned, keywords: 'geocodificação mapa coordenadas ambiguidades' },
