...
function Entry({tenant,actor,account}:{tenant:string;actor:string;account:string}){
 ...
 return <div className="space-y-1"><Button variant="outline" size="sm" onClick={()=>setOpen(true)}>Registrar movimentação</Button>
