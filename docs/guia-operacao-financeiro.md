...
Referência do financeiro em 11/09/2026. A interface de devolução de créditos e seu suporte no banco estão publicados no AGVLog. Este guia não substitui o aceite completo: a validação autenticada de ponta a ponta continua pendente.
