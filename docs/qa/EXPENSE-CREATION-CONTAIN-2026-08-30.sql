...
begin
 ...
 for c in select * from(values
  ...
  ('public.inspect_expense_receipt_upload(uuid,uuid,uuid,text,uuid,jsonb)','d5d7d0bb8c3a9fd2c7b961fae5c33491',true,'v','["search_path=\"\""]'::jsonb,false,true),
  ('public.recalculate_manual_expense_settlement(uuid,uuid)','b8fedb8e21d723b2825758696c0e8b0f',true,'v','["search_path=\"\""]'::jsonb,true,false),
