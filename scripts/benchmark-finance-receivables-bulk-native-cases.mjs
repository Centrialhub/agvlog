...
export async function runCreditNative({query,literal:q,session,finish}){
 ...
 globalThis.__financeBenchmarkDb=db; try {await import('./benchmark-finance-receivables-bulk-10k.mjs');} finally{delete globalThis.__financeBenchmarkDb;await finish(connection,'');}return {passed:6,findings:0};
}
